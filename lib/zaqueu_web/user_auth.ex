defmodule ZaqueuWeb.UserAuth do
  use ZaqueuWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_zaqueu_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ZaqueuWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule ZaqueuWeb.PageLive do
        use ZaqueuWeb, :live_view

        on_mount {ZaqueuWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ZaqueuWeb.UserAuth, :ensure_authenticated}] do
