defmodule ZaqueuWeb.UserAuthTest do
  use ZaqueuWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Zaqueu.Identity
  alias ZaqueuWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ZaqueuWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ZaqueuWeb.Endpoint.subscribe(live_socket_id)
